  ...
  return (
    <div className="pt-16">
      <div className="sm:px-6">
        <div className="flex flex-col flex-wrap sm:flex-row justify-around space-y-8 sm:space-y-0">
          ...
          <div className="w-full sm:w-2/3 md:w-3/4 lg:w-2/3">
            <div className="flex flex-col md:flex-row sm:px-24">
              <img
                ...
                className="w-[150px] h-[150px]"
              />
              <div className="text-[11px] md:text-[11px] xl:text-[14px] 2xl:text-[16px] 2xl:leading-6 leading-4 mt-4 md:mt-6 md:ml-6 md:leading-6 text-black bg-[url('/images/landing/keyTextBG.svg')] bg-cover bg-center bg-no-repeat w-[350px] h-[151px] md:w-[600px] md:h-[216px] pl-8 pr-6 pt-6 m-auto md:pt-8">
